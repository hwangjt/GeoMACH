...
class Trussbraced(Configuration):
    ...
    def __init__(self):
        ...
        self.addComp('fuse', Body([70,10,10,20,10,10,10,50,10,10,20,10,10,10],[25,25,25,25,25],[15]))
        self.addComp('wing', Wing([30,10,10,50],[10,20,10,10]))
        self.addComp('strut', Wing([30],[20],opentip=True))
        self.addComp('vtail', Wing([40,10,10,10],[10,20,10,10],half=True))
        self.addComp('htail', Wing([20],[20]))
...
#        self.comps['htailvtail'].setSurfC1(0,j=0)
