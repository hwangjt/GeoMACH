...
class wingbodytailengine(configuration):
    ...
    def __init__(self):
        ...
        nacelle = halfbody([60,10,20,30],[30],[20,10,10,20],full=True)
        ...
        self.components[3].offset[:] = [3.3, -0.1, 1.5]
        ...
        self.components[4].props['posy'].set([0,0.055],[0,1])
...
if __name__ == '__main__':
    ...
    aircraft = wingbodytailengine()
    aircraft.oml0.write2Tec('wingbodytailengine')
    aircraft.oml0.write2TecC('wingbodytailengineC')
    aircraft.plot()
