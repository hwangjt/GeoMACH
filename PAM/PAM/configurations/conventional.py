...
class Conventional(Configuration):
    ...
    def __init__(self):
        ...
        c['fu'].setm(0,1,[17,4,4,4,4,7,4,13,4,4,7,4])
        ...
        c['lw'].addParam('aileron1','shU',[2,4],P=[[0,0.08,0.08,0],[0,0,0,0]])
        ...
        c['lw'].addParam('aileron2','shL',[2,4],P=[[0,0,0,0],[0,-0.08,-0.08,0]])
        ...
        c['rw'].addParam('aileron1','shU',[2,4],P=[[0,-0.08,-0.08,0],[0,0,0,0]])
        ...
        c['rw'].addParam('aileron2','shL',[2,4],P=[[0,0,0,0],[0,0.08,0.08,0]])
        ...
        c['vt'].addParam('aileron1','shU',[2,1],P=[-0.06,0.0])
        c['vt'].params['aileron1'].setT([0.0,0.25],0)
        c['vt'].addParam('aileron2','shL',[2,1],P=[0.0,0.06])
