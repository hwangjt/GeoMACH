...
class highwing(configuration):

    def __init__(self):
        fuse = halfbody([50,15,50,15,40,10,25,10,10],[25,25,25,25,25,25],[15])
        ...
        wingfuse = fulljunction(wing, 0, fuse, 2, [0,1], [1,3])
        ...
        self.components[0].setSections(1,fuse_sections.rounded3)
        self.components[0].setSections(2,fuse_sections.rounded3)
        self.components[0].setSections(3,fuse_sections.rounded3)
...
if __name__ == '__main__':
    ...
    aircraft = highwing()
    aircraft.oml0.write2Tec('highwing')
    aircraft.oml0.write2TecC('highwingC')
    aircraft.plot()
