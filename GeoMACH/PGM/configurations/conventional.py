...
class Conventional(Configuration):
    ...
    def define_oml_parameters(self):
        ...
        c['lw'].props['pos'].addParam('pos1',[2,3],P=[[0,0,0],[19,3,24]],T=[0,1.0])
        c['lw'].props['scl'].addParam('scl1',[3,1],P=[10,4.5,1.8],T=[0,0.35,1.0])
        c['lw'].props['pos'].addParam('rakedp1',[2,3],P=[[0,0,0],[3,2,0]],T=[0.85,1.0],B=[[True,True,False],[False,False,False]])
        c['lw'].props['scl'].addParam('rakeds',[2,1],P=[0,-1.5],T=[0.85,1.0],B=[True,False])
        ...
        c['rw'].props['pos'].addParam('rakedp1',[2,3],P=[[3,2,0],[0,0,0]],T=[0,0.15],B=[[False,False,False],[True,True,False]])
        c['rw'].props['scl'].addParam('rakeds',[2,1],P=[-1.5,0],T=[0,0.15],B=[False,True])
        ...
        c['lt'].props['pos'].addParam('pos1',[2,3],P=[[0,0,0],[6,0,8]])
        ...
        c['lp'].props['pos'].addParam('pos1',[2,3],P=[[0,0,0],[-2,-0.3,0]])
        c['lp'].props['pos'].addParam('offset',[1,3],P=[21.2,-0.7,9])
        c['lp'].props['scl'].addParam('scl1',[2,1],P=[2.1,3])
        ...
        c['lw_T'].props['fC1'].params['fC1'].setP([0.1])
        c['rw_T'].props['fC1'].params['fC1'].setP([0.1])
