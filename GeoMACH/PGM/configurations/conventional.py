...
class Conventional(Configuration):
    ...
    def define_oml_parameters(self):
        c = self.comps
        c['fu'].addParam('nor1','nor',[1,1],P=[1.0])
        c['fu'].addParam('pos1','pos',[2,3],P=[[0,0,0],[50,0,0]])
        ...
        c['lw'].addParam('pos1','pos',[2,3],P=[[0,0,0],[19,3,24]],T=[0,1.0])
        ...
        c['rw'].addParam('pos1','pos',[2,3],P=[[19,3,-24],[0,0,0]],T=[0,1.0])
        ...
        c['ln'].addParam('nor1','nor',[1,1],P=[1])
        c['ln'].addParam('pos1','pos',[2,3],P=[[0,0,0],[4.5,0,0]])
        ...
        c['rn'].addParam('nor1','nor',[1,1],P=[1])
        c['rn'].addParam('pos1','pos',[2,3],P=[[0,0,0],[4.5,0,0]])
        c['rn'].addParam('scl1','scl',[1,1],P=[1.25])
