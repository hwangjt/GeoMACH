subroutine computeProjection(surf,nu,nv,nD,nT,nC,nP0u,nP0v,nP,nsurf,nedge,& 
           ...
           knot_index,T,C,P0,P,minP,minu,minv)

  implicit none

  !Fortran-python interface directives
  !f2py intent(in) surf,nu,nv,nD,nT,nC,nP0u,nP0v,nP,nsurf,nedge,ngroup,nvert,surf_vert,surf_edge,edge_group,group_k,group_m,group_n,group_d,surf_index_P,edge_index_P,surf_index_C,edge_index_C,knot_index,T,C,P0,P
  ...
  integer ugroup, vgroup, nB, ku, kv, mu, mv
