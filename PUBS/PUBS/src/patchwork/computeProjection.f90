  ...
  do s=1,ns
     ...
     do k=1,nP0
        ...
        do counter=0,100
           ...
           g(1) = 2*dot_product(Pc-P0(k,:),Pu)
           g(2) = 2*dot_product(Pc-P0(k,:),Pv)
           H(1,1) = 2*dot_product(Pu,Pu) + 2*dot_product(Pc-P0(k,:),Puu)
           H(1,2) = 2*dot_product(Pu,Pv) + 2*dot_product(Pc-P0(k,:),Puv)
           H(2,1) = 2*dot_product(Pu,Pv) + 2*dot_product(Pc-P0(k,:),Puv)
           H(2,2) = 2*dot_product(Pv,Pv) + 2*dot_product(Pc-P0(k,:),Pvv)
           do i=1,2
